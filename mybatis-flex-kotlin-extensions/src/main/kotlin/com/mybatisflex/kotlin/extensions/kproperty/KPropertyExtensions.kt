...
infix fun <T> KProperty<T?>.ne(other: KProperty<T?>): QueryCondition = column.ne(other)
...
infix fun <T: String?> KProperty<T>.like(other: T): QueryCondition = column.likeRaw(other)

infix fun <T: String?> KProperty<T>.startsWith(other: T): QueryCondition = column.likeLeft(other)

infix fun <T: String?> KProperty<T>.endsWith(other: T): QueryCondition = column.likeRight(other)

infix fun <T: String?> KProperty<T>.contains(other: T): QueryCondition = column.like(other)

infix fun <T: String?> KProperty<T>.notLike(other: T): QueryCondition =
